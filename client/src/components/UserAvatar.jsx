...
import { logout as leaveLogout } from "../redux/slices/leaveSlice"
...
const UserAvatar = () => {
  ...
  const logoutHandler = async () => {
    try {
      ...
      dispatch(leaveLogout()); // Dispatch other slice logouts as needed

      // Clear any additional local storage or session storage
      localStorage.clear();
