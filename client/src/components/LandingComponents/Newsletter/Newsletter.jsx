...
const Newsletter = () => {
    ...
    return (
        <section className="py-14 max-w-screen-2xl mx-auto">
            <div className="relative overflow-hidden mx-4 px-4 py-14 rounded-2xl bg-blue-600 md:px-8 md:mx-8">
                <div className="relative z-10 max-w-xl mx-auto sm:text-center">
                    <div className="space-y-3">

                        <h3 data-aos="zoom-in-right" className="text-3xl text-white font-bold">
                            Subscribe to our newsletter
                        </h3>
                        <p data-aos="zoom-in-left" className="text-blue-100 leading-relaxed">
