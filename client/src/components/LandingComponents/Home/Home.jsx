      ...
      <section className="mt-24 mx-auto max-w-screen-2xl pb-12 px-4 items-center  lg:flex md:px-8">
        <div className="space-y-4 flex-1 sm:text-center lg:text-left">
          <a
            ...
            className="inline-flex gap-x-6 items-center rounded-full p-1 pr-6 border border-gray-800 text-sm font-medium duration-150 hover:bg-white"
          >
          ...
          <p className="text-gray-800 max-w-xl leading-relaxed sm:mx-auto lg:ml-0">
            ...
            suitable in addressing your human resource management processes for
          ...
          <div className=" flex items-center gap-x-3 sm:text-sm ">
            <button
              ...
              className="flex items-center justify-center gap-x-1 py-2 px-4 shadow-lg text-white font-medium bg-gray-800 duration-150 hover:bg-indigo-600 active:bg-gray-900 rounded-full md:inline-flex"
            >
              Get started
              <svg
