  ...
  return (
    <footer className="bg-white">
      <div className="mx-auto max-w-screen-2xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div>
            ...
            <p data-aos="fade-left"className="mt-4 max-w-xs text-gray-800">
              Lorem ipsum dolor, sit amet consectetur adipisicing elit. Esse non cupiditate quae name
              molestias.
            </p>
            ...
            <ul className="mt-8 flex gap-6">
              <li>
                <a
                  ...
                  rel="noreferrer"
                  target="_blank"
                  className="text-indigo-600 transition hover:opacity-75"
                >
        ...
        <p className="text-xs text-gray-800">&copy; 2024. Capztone Innovative Solution. All rights reserved.</p>
      </div>
    </footer>
  )
}
